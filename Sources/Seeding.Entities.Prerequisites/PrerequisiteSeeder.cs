    ...
    public class PrerequisiteTranslator
    {
        ...
        private BaseModel[] GetMatchModels(IMustacheTemplater templater, string prerequisite)
        {
            return prerequisite switch
            {
                ...
                "trained in Athletics, Lightning Tongue" => BooleanPrerequisite.And(templater, new HaveSpecificSkillProficiency("Trained", "Athletics"), ),
                "Flexible Tail" => new HaveSpecificFeat("FlexibleTail"),
                "trained in Astrology Lore or Occultism" => BooleanPrerequisite.Or(templater, , new HaveSpecificSkillProficiency("Trained", "Occultism")),
                "Orc Warmask" => new HaveSpecificFeat("OrcWarmask"),
                "Beast Trainer" => new HaveSpecificFeat("BeastTrainer"),
                "expert in Intimidation, Orc Warmask" => BooleanPrerequisite.And(templater, new HaveSpecificSkillProficiency("Expert", "Intimidation"), ),
                ...
                "Cel Rau, Straveika, Svetocher, or another lineage from a vampire with the Drink Blood ability" => BooleanPrerequisite.And(templater, ),
                "an animal companion or a familiar" => BooleanPrerequisite.And(templater, ),
                ...
                "Brine May, Snow May, Veil May, or Virga May" => BooleanPrerequisite.And(templater, ),
                ...
                "Drag Down, expert in Athletics" => BooleanPrerequisite.And(templater, , new HaveSpecificSkillProficiency("Expert", "Athletics")),
                ...
                "trained in the hand crossbow" => BooleanPrerequisite.And(templater, ),
                "Drow Shootist Dedication" => new HaveSpecificFeat("DrowShootistDedication"),
                "Drow Shootist Dedication; trained in Crafting" => BooleanPrerequisite.And(templater, , new HaveSpecificSkillProficiency("Trained", "Crafting")),
                ...
                "ability to cast the detect magic cantrip" => ,
                ...
                "expert in Stealth, Pack Hunter" => BooleanPrerequisite.And(templater, new HaveSpecificSkillProficiency("Expert", "Stealth"), ),
                ...
                "master in Athletics, Wall Jump" => BooleanPrerequisite.And(templater, new HaveSpecificSkillProficiency("Master", "Athletics"), ),
                "quillcoat shisk or quill unarmed attack" => ,
                ...
                "legendary in Thievery, Pickpocket" => BooleanPrerequisite.And(templater, new HaveSpecificSkillProficiency("Legendary", "Thievery"), ),
                ...
                "ability to cast spells; Dexterity 14; expert in Acrobatics" => BooleanPrerequisite.And(templater, , , new HaveSpecificSkillProficiency("Expert", "Acrobatics")),
                ...
                "wave order" => ,
                "stone order" => ,
                "flame order, stone order, storm order, or wave order" => BooleanPrerequisite.And(templater, ),
                "fire order" => ,
                ...
                "Rough Terrain Stance, master in Nature" => BooleanPrerequisite.And(templater, , new HaveSpecificSkillProficiency("Master", "Nature")),
                "Geomancer Dedication, legendary in Nature" => BooleanPrerequisite.And(templater, , new HaveSpecificSkillProficiency("Legendary", "Nature")),
                "Geomancer Dedication, master in Nature" => BooleanPrerequisite.And(templater, , new HaveSpecificSkillProficiency("Master", "Nature")),
                "Wis 14 or ability to cast divine spells" => BooleanPrerequisite.Or(templater, new HaveSpecificStat(14, "Wisdom"), ),
                "Armor only" => ,
                "Melee weapon only" => ,
                ...
                "wellspring magic" => ,
                "Wellspring Mage Dedication" => BooleanPrerequisite.And(templater, ),
                ...
                "Runelord Dedication, trained in Crafting" => BooleanPrerequisite.And(templater, , new HaveSpecificSkillProficiency("Trained", "Crafting")),
                ...
                "trained in Intimidation and at least one of Arcana, Nature, Occult, and Religion" => BooleanPrerequisite.And(templater, 
                    new HaveSpecificSkillProficiency("Trained", "Intimidation"),
                    BooleanPrerequisite.Or(templatr,
                        new HaveSpecificSkillProficiency("Trained", "Arcana"),
                        new HaveSpecificSkillProficiency("Trained", "Nature"),
                ...
                "Cha 14 or ability to cast spells from spell slots" => BooleanPrerequisite.Or(templater, new HaveSpecificStat(14, "Charisma"), ),
                ...
                "Munitions Crafter, expert in Crafting" => BooleanPrerequisite.And(templater, , new HaveSpecificSkillProficiency("Expert", "Crafting")),
                ...
                "Pistol Twirl, master in Deception" => BooleanPrerequisite.And(templater, , new HaveSpecificSkillProficiency("Master", "Deception")),
                ...
                "expert in unarmored defense and trained in simple weapons" => ,
                ...
                "master in Deception, Unexpected Sharpshooter Dedication" => BooleanPrerequisite.And(templater, new HaveSpecificSkillProficiency("Master", "Deception" ), ),
                "trained in Deception, Unexpected Sharpshooter Dedication" => BooleanPrerequisite.And(templater, new HaveSpecificSkillProficiency("Trained", "Athletics"), new HaveSpecificFeat("UnexpectedSharpshooterDedication")),
                ...
                "construct companion" => ,
                "armor innovation, construct innovation, or weapon innovation" => BooleanPrerequisite.And(templater, ),
                ...
                "Overwatch Dedication, master in Perception" => BooleanPrerequisite.And(templater, , new HaveSpecificSkillProficiency("Master", "Percepton")),
                "Overwatch Dedication, expert in Perception" => BooleanPrerequisite.And(templater, , new HaveSpecificSkillProficiency("Expert", "Perception")),
                "Sterling Dynamo Dedication" => new HaveSpecificFeat("SterlingDynamoDedication"),
                "Snarecrafter Dedication or Snare Specialist" => BooleanPrerequisite.And(templater, ),
                "Trapsmith Dedication, expert in Crafting" => BooleanPrerequisite.And(templater, , new HaveSpecificSkillProficiency("Expert", "Crafting")),
                "Trapsmith Dedication, master in Crafting" => BooleanPrerequisite.And(templater, , new HaveSpecificSkillProficiency("Master", "Crafting")),
                ...
                "Vehicle Mechanic Dedication, expert in Crafting" => BooleanPrerequisite.And(templater, , new HaveSpecificSkillProficiency("Expert", "Crafting")),
                "Vehicle Mechanic Dedication" => new HaveSpecificFeat("VehicleMechanicDedication"),
                "Vehicle Mechanic Dedication, master in Crafting" => BooleanPrerequisite.And(templater, , new HaveSpecificSkillProficiency("Master", "Crafting")),
                "way of the spellshot" => ,
                "Spellshot Dedication" => new HaveSpecificFeat("SpellshotDedication"),
                "Spellshot Dedication, master in Arcana" => BooleanPrerequisite.And(templater, , new HaveSpecificSkillProficiency("Master", "Arcana")),
                "Explosive Savant" => new HaveSpecificFeat("ExplosiveSavant"),
                "worshipper of Torag or Angradd" => BooleanPrerequisite.And(templater, ),
                ...
                "Firework Technician Dedication, expert in Crafting" => BooleanPrerequisite.And(templater, , new HaveSpecificSkillProficiency("Expert", "Crafting")),
                ...
                "Gunslinger Dedication, expert in Perception" => BooleanPrerequisite.And(templater, , new HaveSpecificSkillProficiency("Expert", "Perception")),
